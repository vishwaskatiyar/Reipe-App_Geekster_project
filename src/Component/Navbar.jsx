...
const Navbar = () => {
  ...
  return (
    <header className="w-full  fixed z-10 bg-black opacity-80">
      <nav className="flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between">
        ...
        >
          <img
            src={Logo}
            alt="Logo"
            className=" hidden md:block w-8 h-8 lg:h-14"
          />{" "}
          Flavor
          <span>Verse</span>
        </a>
        ...
        <Button
          title="sign in"
          containerStyle="hidden md:block bg-transparent text-white border-white border hover:bg-white hover:text-slate-700 rounded-full min-w-[130px]"
        />
        <button
